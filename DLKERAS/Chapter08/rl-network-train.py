...
# 파라미터 초기화
DATA_DIR = "../data"
NUM_ACTIONS = 3 # 행동의 갯수 정의 (좌, 정지, 우)
GAMMA = 0.99 # 미래에 대한 보상의 감가율
INITIAL_EPSILON = 0.1 # 시작 epsilon
FINAL_EPSILON = 0.0001 # 최종 epsilon
MEMORY_SIZE = 50000 # 경험 반복 메모리의 크기
